# TripSense Knowledge Base

This knowledge base stores reusable planning, architecture, and review context for Codex, Foam, GitHub, and the engineering team.
...
- [Web Agent Rules](../apps/web/tripsense/AGENTS.md)
