...
const popularDestinations = [
  {
    ...
    location: "France",
    description:
      "The city of light, world-class art, culinary delights, and iconic landmarks.",
  ...
  },
  {
    ...
    location: "Japan",
    description:
      "Futuristic skyscrapers meet ancient temples, incredible street food, and vibrant nightlife.",
  ...
  },
  {
    ...
    description:
      "Breathtaking mountain peaks, crystal-clear lakes, and world-renowned alpine railways.",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            ...
            <p className="text-base text-muted-foreground">
              Get inspired by curated locations, intelligent itineraries, and
          ...
          <Link href="/explore">
            <Button
              variant="outline"
              className="rounded-full gap-2 px-5 font-semibold shrink-0"
            >
