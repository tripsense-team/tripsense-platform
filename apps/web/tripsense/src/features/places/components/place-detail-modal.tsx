                ...
                {place.reviews && place.reviews.length > 0 ? (
                  <div className="space-y-3">
                    {place.reviews.map((rev, idx) => (
                      <div
                        key={idx}
                        className="p-3.5 rounded-2xl bg-muted/50 border border-border/60 space-y-1.5 text-xs transition-opacity duration-300"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            {rev.profilePhotoUrl && (
                        ...
                        {rev.text && (
                          <p className="text-muted-foreground leading-relaxed pt-1 text-xs">
                            {rev.text}
                          </p>
                        )}
                      </div>
