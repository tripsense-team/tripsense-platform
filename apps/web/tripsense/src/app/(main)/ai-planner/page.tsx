  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-5xl mx-auto">
      <div className="text-center space-y-3 max-w-2xl mx-auto">
        <Badge
          variant="secondary"
          className="bg-primary/10 text-primary border-primary/20 gap-1.5 px-3 py-1 font-semibold text-xs"
        >
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Tell us where you want to go, your travel style, or budget, and our AI
          will build a personalized day-by-day itinerary for you.
        </p>
      </div>
