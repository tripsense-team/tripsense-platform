...
_BUDGETS = {
    ExecutionProfile.L0_DIRECT: ExecutionBudget(ExecutionProfile.L0_DIRECT, 0, 0, 0, 0, 0, 0, 2_000, 500, 45),
    ExecutionProfile.L1_CONTEXTUAL: ExecutionBudget(ExecutionProfile.L1_CONTEXTUAL, 1, 1, 0, 1, 1, 0, 4_000, 800, 50),
    ExecutionProfile.L2_GROUNDED_LOOKUP: ExecutionBudget(ExecutionProfile.L2_GROUNDED_LOOKUP, 1, 2, 1, 3, 1, 0, 6_000, 1_000, 60),
    ExecutionProfile.L3_RECOMMEND: ExecutionBudget(ExecutionProfile.L3_RECOMMEND, 1, 2, 1, 4, 1, 1, 8_000, 1_500, 65),
    ExecutionProfile.L4_PLAN: ExecutionBudget(ExecutionProfile.L4_PLAN, 1, 2, 1, 8, 2, 1, 12_000, 2_000, 80),
    ExecutionProfile.L5_PROPOSE_ACTION: ExecutionBudget(ExecutionProfile.L5_PROPOSE_ACTION, 0, 1, 0, 3, 1, 0, 4_000, 800, 45),
}
