...
public class SocialTripShare {
  ...
  @Column(name = "current_snapshot_version")
  private Integer currentSnapshotVersion;

  @Column(name = "detail_availability", nullable = false, length = 48)
  @Builder.Default
  private String detailAvailability = "SUMMARY_ONLY_REPUBLISH_REQUIRED";

  @Column(name = "date_precision", nullable = false, length = 24)
  @Builder.Default
  private String datePrecision = "DAY_NUMBER_ONLY";

  @Column(name = "publication_revision")
