...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(Exception.class) ResponseEntity<ErrorResponse> unexpected(){ return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ErrorResponse.of("INTERNAL_ERROR", "An unexpected error occurred")); }
}
