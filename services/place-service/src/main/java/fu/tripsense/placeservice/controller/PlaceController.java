...
public class PlaceController {
    ...
    public ResponseEntity<ApiResponse<PlaceRecommendationResult>> recommendations(
        ...
        if ((request.lat() == null) != (request.lng() == null)) {
            return ResponseEntity.badRequest().body(
                    ApiResponse.error("INVALID_COORDINATES", "Latitude and longitude must be provided together"));
        }
    ...
    public ResponseEntity<ApiResponse<PlaceDto>> getById(
            ...
            @RequestParam(name = "lat", required = false) Double lat,
            @RequestParam(name = "lng", required = false) Double lng,
            @RequestParam(name = "includePhoto", required = false, defaultValue = "false") boolean includePhoto
    ) {
        ...
        Optional<PlaceDto> place = includePhoto
