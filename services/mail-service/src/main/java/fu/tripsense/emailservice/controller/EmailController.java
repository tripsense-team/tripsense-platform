...
public class EmailController {
  ...
  public ResponseEntity<ApiResponse<EmailResponse>> sendVerificationEmail(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            ...
            new EmailResponse(true, "Verification email request processed")));
  }

  @PostMapping("/password-reset")
  public ResponseEntity<ApiResponse<EmailResponse>> sendPasswordResetEmail(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            ...
            new EmailResponse(true, "Password reset email request processed")));
  }
  ...
  public ResponseEntity<ApiResponse<EmailResponse>> sendTemplateEmail(
    ...
    log.info(
        "Received request to send template email [{}] to {}",
        request.templateName(),
        request.toEmail());
    emailService.sendTemplateEmail(
        request.toEmail(), request.subject(), request.templateName(), request.variables());
    return ResponseEntity.ok(
        ApiResponse.success(
